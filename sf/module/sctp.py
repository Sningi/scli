...
sctp_cfg_field = [('sctp_decode', 'sctp_decode_enable'),
                    ...
                    ("s1ap_decode", "s1ap_decode_enable"),
                    ("s1ap_decode_skip_paging", "s1ap_decode_skip_paging_enable"),
                    ("s1ap_cdr", "s1ap_cdr_enable"),
                    ("s1ap_cdr_output", "s1ap_cdr_output_enable"),
                    ("s1ap_nas_decrypt", "s1ap_nas_decrypt_enable"),
                    ("s1ap_nas_decrypted_output", "s1ap_nas_decrypted_output_enable"),
                    ("s1ap_learn_lte", "s1ap_learn_lte_enable"),
                    ...
                    ("diameter_decode", "diameter_decode_enable"),
                    ("s6a_cdr_proc", "s6a_cdr_proc_enable"),
                    ("s6a_cdr_timeout", "s6a_cdr_timeout"),
                    ("s6a_auth_ass_timeout", "s6a_auth_ass_timeout"),
                    ("s6a_create_imsi_vector", "s6a_create_imsi_vector_open"),
                  ]
